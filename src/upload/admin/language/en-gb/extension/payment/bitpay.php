...
$_['text_success']           = 'Success: You have modified the GloBee payment module!';
$_['text_edit']              = 'Edit GloBee';
$_['text_changes']           = 'There are unsaved changes.';
$_['text_bitpay']            = '<a onclick="window.open(\'https://globee.com/\');"><img src="view/image/payment/globee_small.png" alt="GloBee" title="globee" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_general']           = 'General';
$_['text_statuses']          = 'Order Statuses';
$_['text_advanced']          = 'Advanced';
$_['text_connect_to_bitpay'] = 'Connect to <img src="view/image/payment/globee_logo_38x24.svg" style="height: 36px; margin: -11px -10px -10px -9px">';
...
$_['text_forum']             = 'Forum';
$_['text_bitpay_labs']       = '<a href="https://github.com/GloBee-Official/opencart3-plugin">GloBee OpenCart plugin on Github</a>';
...
$_['text_popup']             = 'It appears your browser is blocking GloBee&apos;s pop-up. Click below to continue.';
...
$_['help_api_access']        = "<strong>Livenet (default):</strong> real Bitcoin transactions<br>\n" .
								"<strong>Testnet:</strong> transactions on the Bitcoin Testnet. Requires an account at <strong><em>test.globee.com</em></strong>";
...
$_['help_send_buyer_info']   = 'Buyer information is sent to GloBee so that it can be included on the invoice';
...
$_['help_notify_url']        = 'GloBee&#8217;s IPN will post invoice status updates to this URL';
$_['help_return_url']        = 'GloBee will provide a redirect link to the user for this URL upon successful payment of the invoice';
$_['help_debug']             = 'Enabling debug will write sensitive data to a log file. You should always disable unless instructed otherwise';

// Success
$_['success_connected']		  = 'Success: Connected to GloBee %s';
$_['success_disconnect']      = 'Success: Disconnected from GloBee';
$_['success_clear']           = 'Success: The GloBee log has been cleared';
$_['success_support_request'] = 'Success: Your Support Request has been sent. Hang in there!';

// Warning
$_['warning_permission']        = 'Warning: You do not have permission to modify the GloBee payment module.';
$_['warning_unable_to_connect'] = 'Warning: Unable to connect to GloBee. Check the log for more information.';
$_['warning_disconnected']      = 'Warning: You are no longer connected to GloBee. <a href="%s" class="alert-link">Click here to reconnect.</a>';

// Error
$_['error_status']                        = 'You cannot enable this payment method until you have connected your OpenCart store to GloBee. <a href="%s">Connect now!</a>';
...
// Log
$_['log_error_install']          = 'The GloBee payment extension was not installed correctly or the files are corrupt. Please reinstall the extension. If this message persists after a reinstall, contact support@globee.com with this message.';
$_['log_unable_to_connect']      = 'Unable to connect to GloBee';
...
$_['log_connection_key']         = 'Could not retrieve tokens from GloBee.';
